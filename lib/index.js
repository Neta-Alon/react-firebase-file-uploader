...
function isProblematicGoogleDriveFile(file) {
  /* Neta: The problematic file changes lastModified times on every read. */
  var lastModified1 = file.lastModified;
  var lastModified2 = file.lastModified;
  ...
  _createClass(FirebaseFileUploader, [{
    ...
    value: function startUpload(file) {
      ...
      Promise.resolve().then(function () {
        ...
        return onUploadError && onUploadError(error, null);
      });
    }
  }, {
    key: "render",
